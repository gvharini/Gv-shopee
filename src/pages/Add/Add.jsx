  ...
  return (
    ...
    <form onSubmit={onSubmitHandler} className="form-container">
      ...
      <div className="form-group">
        ...
        <input type="text" onChange={(e) => setName(e.target.value)} value={name} placeholder='Enter product name' className='form-input' required/>
      </div>
      <div className="form-group">
        <p className="form-label">Product description</p>
        <textarea type="text" placeholder='type product description'onChange={(e) => setDescription(e.target.value)} value={description} className='form-input' required/>
      </div>
      <div className="form-group-horizontal">
        ...
        <input type="number" className='form-input price-input' onChange={(e) => setPrice(e.target.value)} value={price} placeholder='30'/>
      </div>
      </div>
      <div>
      ...
      <div className="checkbox-group">
        <input onChange={()=> setBestSeller((prev) => !prev)} checked={bestSeller} className='check' type="checkbox" id="bestseller" />
